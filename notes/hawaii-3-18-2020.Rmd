...
Earthmover's distance (EMD) is defined as a function of the optimal flow $F =
[f_ij]$ and the ground distance 

$$E M D(P,
  Q)=\frac{\sum_{i=1}^{m} \sum_{j=1}^{n} d_{i j} f_{i j}}{\sum_{i=1}^{m}
    \sum_{j=1}^{n} f_{i j}}$$
