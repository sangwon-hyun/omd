---
title: Cluster boundary comparison using OMD
...
```{r all-boundaries, fig.width = 18, fig.height = 12}
...
```{r mds, fig.width = 4, fig.height = 5}
...
```{r distmat, fig.width = 6, fig.height = 6}
